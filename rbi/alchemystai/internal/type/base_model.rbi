    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Alchemystai::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Alchemystai::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
          ...
          sig do
            returns(
              T::Hash[
                ...
                T.all(
                  Alchemystai::Internal::Type::BaseModel::KnownField,
                  { type: Alchemystai::Internal::Type::Converter::Input }
                )
              ]
            )
          end
        ...
        class << self
          ...
          sig do
            params(
              model: Alchemystai::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Alchemystai::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Alchemystai::Internal::AnyHash) }
        def to_h
        end
