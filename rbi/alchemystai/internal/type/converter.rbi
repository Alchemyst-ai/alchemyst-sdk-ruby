  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Alchemystai::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Alchemystai::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Alchemystai::Internal::Type::Converter::Input,
              value: T.anything,
              state: Alchemystai::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
