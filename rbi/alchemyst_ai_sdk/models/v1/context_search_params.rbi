    ...
    module V1
      class ContextSearchParams < AlchemystAISDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              AlchemystAISDK::V1::ContextSearchParams,
        ...
        sig do
          returns(
            T.nilable(AlchemystAISDK::V1::ContextSearchParams::Scope::OrSymbol)
          )
        end
        attr_reader :scope
        ...
        module Scope
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, AlchemystAISDK::V1::ContextSearchParams::Scope)
            end
          ...
          INTERNAL =
            T.let(
              :internal,
              AlchemystAISDK::V1::ContextSearchParams::Scope::TaggedSymbol
            )
          EXTERNAL =
            T.let(
              :external,
