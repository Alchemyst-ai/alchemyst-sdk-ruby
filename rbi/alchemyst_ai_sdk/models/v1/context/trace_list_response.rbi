      ...
      module Context
        class TraceListResponse < AlchemystAISDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                AlchemystAISDK::Models::V1::Context::TraceListResponse,
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  AlchemystAISDK::Models::V1::Context::TraceListResponse::Trace
                ]
              )
            )
          end
          ...
          sig do
            params(
              traces:
                T::Array[
                  AlchemystAISDK::Models::V1::Context::TraceListResponse::Trace::OrHash
                ]
            ).void
          end
          attr_writer :traces
