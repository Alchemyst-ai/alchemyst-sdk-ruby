...
module AlchemystAISDK
  module Resources
    class V1
      class Context
        sig { returns(AlchemystAISDK::Resources::V1::Context::Traces) }
        attr_reader :traces

        sig { returns(AlchemystAISDK::Resources::V1::Context::View) }
        attr_reader :view

        sig { returns(AlchemystAISDK::Resources::V1::Context::Memory) }
        attr_reader :memory
        ...
        sig do
          params(
            ...
            metadata: T.anything,
            scope: AlchemystAISDK::V1::ContextSearchParams::Scope::OrSymbol,
            user_id: String,
            request_options: AlchemystAISDK::RequestOptions::OrHash
          ).returns(AlchemystAISDK::Models::V1::ContextSearchResponse)
        end
        def search(
