...
class Alchemystai::Test::SingletonClient < Alchemystai::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Alchemystai::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Alchemystai::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @alchemyst_ai = Alchemystai::Test::SingletonClient.instance
  end
