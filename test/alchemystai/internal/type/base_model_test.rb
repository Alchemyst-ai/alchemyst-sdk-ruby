...
class Alchemystai::Test::PrimitiveModelTest < Minitest::Test
  A = Alchemystai::Internal::Type::ArrayOf[-> { Integer }]
  H = Alchemystai::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Alchemystai::Internal::Type::Union
  end

  class B < Alchemystai::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Alchemystai::Internal::Type::Unknown,
      Alchemystai::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Alchemystai::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Alchemystai::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Alchemystai::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Alchemystai::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Alchemystai::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Alchemystai::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Alchemystai::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Alchemystai::Internal::Type::Boolean, true] => true,
      [Alchemystai::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Alchemystai::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Alchemystai::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Alchemystai::Internal::Type::Converter.new_coerce_state
      Alchemystai::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Alchemystai::Internal::Type::Converter.dump(target, input, state: state)
...
class Alchemystai::Test::EnumModelTest < Minitest::Test
  class E0
    include Alchemystai::Internal::Type::Enum
...
class Alchemystai::Test::CollectionModelTest < Minitest::Test
  A1 = Alchemystai::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Alchemystai::Internal::Type::HashOf[Integer]

  A2 = Alchemystai::Internal::Type::ArrayOf[H1]
  H2 = Alchemystai::Internal::Type::HashOf[-> { A1 }]

  A3 = Alchemystai::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Alchemystai::Internal::Type::HashOf[Integer, nil?: true]
...
class Alchemystai::Test::BaseModelTest < Minitest::Test
  class M1 < Alchemystai::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Alchemystai::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Alchemystai::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Alchemystai::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Alchemystai::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Alchemystai::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Alchemystai::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Alchemystai::Errors::ConversionError => e
...
class Alchemystai::Test::UnionTest < Minitest::Test
  class U0
    include Alchemystai::Internal::Type::Union
  ...
  class M2 < Alchemystai::Internal::Type::BaseModel
  ...
  class M4 < Alchemystai::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Alchemystai::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Alchemystai::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Alchemystai::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Alchemystai::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Alchemystai::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Alchemystai::Internal::Type::Unknown, Alchemystai::Internal::Type::Unknown] => true,
      [Alchemystai::Internal::Type::Boolean, Alchemystai::Internal::Type::Boolean] => true,
      [Alchemystai::Internal::Type::Unknown, Alchemystai::Internal::Type::Boolean] => false,
...
class Alchemystai::Test::MetaInfoTest < Minitest::Test
  A1 = Alchemystai::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Alchemystai::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
