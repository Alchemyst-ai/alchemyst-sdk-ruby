...
class AlchemystAISDK::Test::SingletonClient < AlchemystAISDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: AlchemystAISDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class AlchemystAISDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @alchemyst_ai = AlchemystAISDK::Test::SingletonClient.instance
  end
