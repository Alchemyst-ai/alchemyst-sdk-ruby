...
class AlchemystAISDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/api/v1/context/add").to_return_json(status: 500, body: {})

    alchemyst_ai = AlchemystAISDK::Client.new(base_url: "http://localhost", api_key: "My API Key")

    assert_raises(AlchemystAISDK::Errors::InternalServerError) do
  ...
  def test_client_given_request_default_retry_attempts
    ...
    alchemyst_ai =
      AlchemystAISDK::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 3)
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/api/v1/context/add").to_return_json(
      status: 500,
    ...
    alchemyst_ai =
      AlchemystAISDK::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(AlchemystAISDK::Errors::APIConnectionError) do
    ...
    assert_requested(:any, "http://localhost/redirected", times: AlchemystAISDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: AlchemystAISDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: AlchemystAISDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/api/v1/context/add").to_return_json(status: 200, body: {})
