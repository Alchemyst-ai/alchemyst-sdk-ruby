...
class AlchemystAISDK::Test::PrimitiveModelTest < Minitest::Test
  A = AlchemystAISDK::Internal::Type::ArrayOf[-> { Integer }]
  H = AlchemystAISDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend AlchemystAISDK::Internal::Type::Union
  end

  class B < AlchemystAISDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      AlchemystAISDK::Internal::Type::Unknown,
      AlchemystAISDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => AlchemystAISDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [AlchemystAISDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [AlchemystAISDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [AlchemystAISDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = AlchemystAISDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        AlchemystAISDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [AlchemystAISDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [AlchemystAISDK::Internal::Type::Boolean, true] => true,
      [AlchemystAISDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => AlchemystAISDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        AlchemystAISDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = AlchemystAISDK::Internal::Type::Converter.new_coerce_state
      AlchemystAISDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        AlchemystAISDK::Internal::Type::Converter.dump(target, input, state: state)
...
class AlchemystAISDK::Test::EnumModelTest < Minitest::Test
  class E0
    include AlchemystAISDK::Internal::Type::Enum
...
class AlchemystAISDK::Test::CollectionModelTest < Minitest::Test
  A1 = AlchemystAISDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = AlchemystAISDK::Internal::Type::HashOf[Integer]

  A2 = AlchemystAISDK::Internal::Type::ArrayOf[H1]
  H2 = AlchemystAISDK::Internal::Type::HashOf[-> { A1 }]

  A3 = AlchemystAISDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = AlchemystAISDK::Internal::Type::HashOf[Integer, nil?: true]
...
class AlchemystAISDK::Test::BaseModelTest < Minitest::Test
  class M1 < AlchemystAISDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < AlchemystAISDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < AlchemystAISDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, AlchemystAISDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = AlchemystAISDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = AlchemystAISDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(AlchemystAISDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue AlchemystAISDK::Errors::ConversionError => e
...
class AlchemystAISDK::Test::UnionTest < Minitest::Test
  class U0
    include AlchemystAISDK::Internal::Type::Union
  ...
  class M2 < AlchemystAISDK::Internal::Type::BaseModel
  ...
  class M4 < AlchemystAISDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, AlchemystAISDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < AlchemystAISDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, AlchemystAISDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class AlchemystAISDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include AlchemystAISDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [AlchemystAISDK::Internal::Type::Unknown, AlchemystAISDK::Internal::Type::Unknown] => true,
      [AlchemystAISDK::Internal::Type::Boolean, AlchemystAISDK::Internal::Type::Boolean] => true,
      [AlchemystAISDK::Internal::Type::Unknown, AlchemystAISDK::Internal::Type::Boolean] => false,
...
class AlchemystAISDK::Test::MetaInfoTest < Minitest::Test
  A1 = AlchemystAISDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = AlchemystAISDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
