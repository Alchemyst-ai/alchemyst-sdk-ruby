    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { AlchemystAISDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { AlchemystAISDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            AlchemystAISDK::FilePart.new(value)
          in AlchemystAISDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in AlchemystAISDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [AlchemystAISDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: AlchemystAISDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in AlchemystAISDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in AlchemystAISDK::Internal::Type::Converter
              ...
              AlchemystAISDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(AlchemystAISDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
