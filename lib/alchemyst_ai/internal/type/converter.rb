    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { AlchemystAI::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { AlchemystAI::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            AlchemystAI::FilePart.new(value)
          in AlchemystAI::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in AlchemystAI::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [AlchemystAI::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: AlchemystAI::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in AlchemystAI::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in AlchemystAI::Internal::Type::Converter
              ...
              AlchemystAI::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(AlchemystAI::Internal::Type::Converter, T::Class[T.anything]) }
        end
