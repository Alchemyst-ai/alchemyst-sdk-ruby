...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/alchemystai/helpers/` and `examples/` directory.
...
require_relative "../lib/alchemystai"
...
```ruby
gem "alchemystai", git: "https://www.github.com/stainless-sdks/alchemyst-ai-sdk-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/stainless-sdks/alchemyst-ai-sdk-ruby' '<path-to-repo>'
```

```ruby
gem "alchemystai", path: "<path-to-repo>"
```
